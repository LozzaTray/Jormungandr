...
%Numerous variants of the SBM  have been proposed, e.g., the MMSBM [Airoldi et al. (2009)]
%and OSBM [Zhu et al. (2016)], but these do not include features in the graph generation
%process.
