...
\url{https://github.com/LozzaTray/Jormungandr-code}. Table~\ref{tab:hyperparams} contains the hyper-parameters for each experiment run. The thinned samples are generated as,
\begin{equation}
